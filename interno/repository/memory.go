...
func NewMemoryStore() *MemoryStore {
	return &MemoryStore{
		alunos: []model.Aluno{
			...
			{ID: 6, Nome: "Joao Pedro", Foto: "https://via.placeholder.com/150", Turma: "2026.1"},
			...
			{ID: 9, Nome: "Sofia Vitoria", Foto: "https://via.placeholder.com/150", Turma: "2026.1"},
		...
		fotos: []model.Foto{
			{ID: 1, AlunoID: 1, URL: "https://via.placeholder.com/800x600", Legenda: "Projeto integrador"},
			{ID: 2, AlunoID: 1, URL: "https://via.placeholder.com/800x600", Legenda: "Apresentacao final"},
		},
		admins: []model.Admin{
